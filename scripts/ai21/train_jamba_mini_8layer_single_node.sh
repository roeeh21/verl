...
# rm -rf /dev/shm/mini_8layer && mkdir -p /dev/shm/mini_8layer && gcloud storage cp gs://ai21-mammoth-storage/models/jamba_hf/mini_8layer_for_debug/* /dev/shm/mini_8layer
...
python3 -m verl.trainer.main_ppo \
                ...
                actor_rollout_ref.model.path=/dev/shm/mini_8layer \
