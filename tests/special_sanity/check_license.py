...
# AI21 Labs headers
license_head_ai21_2024 = "Copyright 2024 AI21 Labs"
license_head_ai21_2025 = "Copyright 2025 AI21 Labs"
...
license_headers = [
    ...
    license_head_ai21_2024,
    license_head_ai21_2025,
]
...
if __name__ == "__main__":
    ...
    for path in pathlist:
        ...
        # Skip generated, build, and vendor directories that should not be license-checked
        skip_dirs = ("build", "dist", ".eggs", ".venv", "venv", "env", "__pycache__", "site-packages")
        if any(part in skip_dirs for part in Path(path_in_str).parts):
            continue
        print(path_in_str)
