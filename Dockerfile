...
# Download prebuilt flash-attn wheel (built against torch 2.10+cu126)
RUN mkdir -p wheels && \
    gcloud storage cp gs://ai21-publishing-studio-experiments/research-serving/flash-attn/cu126/flash_attn-2.8.3-cp311-cp311-linux_x86_64.whl wheels/
