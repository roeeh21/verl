...
class RolloutConfig(BaseConfig):
    ...
    offload_state_dict_before_load: bool = False  # TODO AI21: nicer to move this to FSDP config

    disable_output_tokens: Optional[list[str]] = None

    generate_chunk_size: Optional[int] = None

    mamba_ssm_cache_dtype_fp32: bool = False
