...
def load_reward_manager(
    ...
    if compute_score is None:
        ...
        elif reward_manager_name == "ai21":
            final_compute_score = None
        else:
            final_compute_score = default_compute_score

    if reward_manager_name == "ai21":
        reward_kwargs["ai21_evaluators_config_file"] = config.reward_model.get("ai21_evaluators_config_file")
        reward_kwargs["ai21_evaluators_timeout"] = config.reward_model.get("ai21_evaluators_timeout")
        reward_kwargs["ai21_clean_thinking_trace"] = config.reward_model.get("ai21_clean_thinking_trace")
        reward_kwargs["ai21_enforce_thinking_trace"] = config.reward_model.get("ai21_enforce_thinking_trace")
        reward_kwargs["ai21_evaluators_async"] = config.reward_model.get("ai21_reward_async", True)
        reward_kwargs["ai21_evaluators_batch_size"] = config.reward_model.get("ai21_evaluators_batch_size", 0)
        reward_kwargs["ai21_evaluators_actors_amount"] = config.reward_model.get("ai21_evaluators_actors_amount")
        reward_kwargs["ai21_evaluators_actor_cpus"] = config.reward_model.get("ai21_evaluators_actor_cpus", 1)
        reward_kwargs["ai21_evaluators_spread_per_node"] = config.reward_model.get(
            "ai21_evaluators_spread_per_node", True
        )
        reward_kwargs["stop_seq_to_strip"] = config.actor_rollout_ref.rollout.get("stop")
        reward_kwargs["remote_save_path"] = config.trainer.get("remote_save_path", None)
