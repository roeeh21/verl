...
class FilterGroupsConfig(BaseConfig):
    ...
    _frozen_fields = [
        ...
        "metric",
        "max_num_gen_batches",
        "num_times_to_snooze_easy_examples",
        "snooze_mean_score_threshold",
        "verbose_snoozing",
        "strict",
        "filter_ai21_eval_errors",
        "carry_leftovers_to_next_step",
    ]

    enable: bool = False
    metric: Optional[str] = None
    max_num_gen_batches: int = 0
    num_times_to_snooze_easy_examples: int = 0
    snooze_mean_score_threshold: float = 1.0
    verbose_snoozing: bool = False
    strict: bool = False
    filter_ai21_eval_errors: bool = True
    carry_leftovers_to_next_step: bool = True
